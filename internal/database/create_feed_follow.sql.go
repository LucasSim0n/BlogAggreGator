...
SELECT insert_feed_follows.id, insert_feed_follows.created_at, insert_feed_follows.updated_at, insert_feed_follows.user_id, insert_feed_follows.feed_id, feeds.name AS feed_name, users.name AS user_name
